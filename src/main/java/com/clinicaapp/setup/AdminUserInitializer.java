...
public class AdminUserInitializer implements ApplicationRunner {
    ...
    private List<Servicio> createDefaultServices() {
        ...
        List<Servicio> servicios = List.of(
                ...
                crearServicio("Vacunación Triple Felina", "Protección contra virus respiratorios y panleucopenia.",
                        45000.0),
                ...
                crearServicio("Esterilización Perro", "Cirugía programada (Ovariohisterectomía/Orquiectomía).",
                        350000.0),
    ...
    private List<Map<String, String>> generarEquipoMedicoAleatorio() {
        ...
        String[][] poolDoctores = {
                { "Dr. Ricardo Alzate", "Director Médico", "15 años de experiencia",
                        "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&q=80" },
                { "Dra. Claudia Ortiz", "Cirujana Jefe", "12 años de experiencia",
                        "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=400&q=80" },
                { "Dr. Sergio Méndez", "Especialista en Urgencias", "10 años de experiencia",
                        "https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=400&q=80" },
                { "Dra. Valentina Ríos", "Medicina Interna", "8 años de experiencia",
                        "https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=400&q=80" },
                { "Dr. Fernando Ruiz", "Traumatólogo", "11 años de experiencia",
                        "https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=400&q=80" },
                { "Dra. Isabella Santos", "Cardióloga", "7 años de experiencia",
                        "https://images.unsplash.com/photo-1527613426441-4da17471b66d?w=400&q=80" },
                { "Dr. Javier Morales", "Dermatólogo", "9 años de experiencia",
                        "https://images.unsplash.com/photo-1471017851983-fc49d89c57c2?w=400&q=80" },
                { "Dra. Beatriz Luna", "Oftalmóloga", "6 años de experiencia",
                        "https://images.unsplash.com/photo-1504813184591-01592fd03cfd?w=400&q=80" },
                { "Dr. Andres Silva", "Anestesiólogo", "13 años de experiencia",
                        "https://images.unsplash.com/photo-1537151625747-7ae77de5118b?w=400&q=80" }
        };

        List<Integer> indices = new ArrayList<>(
                IntStream.range(0, poolDoctores.length).boxed().collect(Collectors.toList()));
